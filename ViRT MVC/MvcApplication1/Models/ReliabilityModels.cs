...
{
	public class ReliabilityModels
	{
		 ...
		 */
		public ReliabilityModels(String pDataCenter, int pNetworkID, int pFarmID, String pPipeline,
		...
		public DataTable CalculateComponent(String pComponent){
            ...
            SqlConnection dbConnect = new SqlConnection("Data Source=FIDEL3127;Initial Catalog=VisDataTestCOSMOS;Uid=dataUser;pwd=userData!;");
			dbConnect.Open();
		...
		public DataTable OverviewCalculate()
		{
			...
			for (int i = 0; i < length; i++)
			{
                temp = CalculateComponent((String)pipelineTable.Rows[i]["Pipeline"]);
